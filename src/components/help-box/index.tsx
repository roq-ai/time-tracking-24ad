...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Finance Manager'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Administrator', 'Project Manager', 'Finance Manager', 'IT Consultant'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `Time tracking.`;
